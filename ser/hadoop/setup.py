...
setup(
    ...
    install_requires=['hadoop>=0.1.4', 'ebay-datameta-core>=1.0.0'
                    ], # https://github.com/tracelytics/python-hadoop/blob/master/setup.py

    cmdclass={'test': PyTest},
    author_email='michael.bergens@gmail.com',
    description='DataMeta DOM/Hadoop for Python',
    long_description = LONG_DESCRIPTION,
    zip_safe=False,
    packages=['ebay-datameta_hadoop'],
    include_package_data=True,
    platforms='any',
    test_suite='tests.test_hadoop',
    classifiers = [
